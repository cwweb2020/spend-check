    ...
    <>
      ...
      <section className="total-category-decider">
        ...
        <div className="cat-decider-big-container">
          <h4 className="cat-decider-subtitulo">Categorias a trackear</h4>
          <div className="cat-decider-wrapper">
            <div className="uno">
              {categoryData.allCategories.map((category, { icon, name, id }) => {
                return (
                  <div onClick={() => handleAddToSelected(category)} key={id}>
